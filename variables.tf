...
variable "public_subnet_ids" {
  description = "AutoScalingGroup Subnet IDs to create gitsi Host into (=> public)"
  type        = list(string)
}
...
# gitsi
# --------------------------------------------------------------------------
variable "gitsi_admin_username" {
  description = "The name of prodosy/gitsi user who can start meetings"
  type        = string
}

variable "gitsi_admin_password" {
  description = "The password of prodosy/gitsi user who can start meetings"
  type        = string
}
...
variable "default_background_color" {
  description = "Background color for gitsi installation"
  type        = string
  default     = "#474747"
}
...
# --------------------------------------------------------------------------
variable "host" {
  description = "The host part of the Route53 A record referencing the gitsi DNS (e.g. `gitsi` for `gitsi.example.com`)"
  type        = string
  default     = "meet"
}

variable "domain" {
  description = "The domain part of the Route53 A record referencing the gitsi DNS (e.g. `example` for `gitsi.example.com`)"
  type        = string
  default = "etherpad.live"
}
...
variable "key_pair_name" {
  description = "Name of pre-existing AWS Key Pair name to associate with gitsi"
  type        = string
  default     = "terraform"
}
...
variable "gitsi_cidrs" {
  description = "IPV4 CIDRs to allow for gitsi access"
  type        = map(string)
  default = {
    "ALL-IPv4" = "0.0.0.0/0"
  }
